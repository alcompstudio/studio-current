# Документация для `dropdown-menu.tsx`

*Путь к файлу: `src/components\ui\dropdown-menu.tsx`*

## Зависимости файла

```mermaid
flowchart TD
    dropdown_menu_tsx[dropdown-menu.tsx]
    react[react]
    dropdown_menu_tsx --> react
    react_dropdown_menu[@radix-ui/react-dropdown-menu]
    dropdown_menu_tsx --> react_dropdown_menu
    lucide_react[lucide-react]
    dropdown_menu_tsx --> lucide_react
    utils[@/lib/utils]
    dropdown_menu_tsx --> utils
```

### `DropdownMenu` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuTrigger` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuContent` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuItem` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuCheckboxItem` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuRadioItem` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuLabel` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuSeparator` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuShortcut` (ReactComponent)
...
---
### `DropdownMenuShortcut` (Identifier)

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuGroup` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuPortal` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuSub` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuSubContent` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuSubTrigger` (Variable (CallExpression))

*Источник: `src/components\ui\dropdown-menu.tsx`*

---
### `DropdownMenuRadioGroup` (Variable (PropertyAccessExpression))
