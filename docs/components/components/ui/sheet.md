# Документация для `sheet.tsx`

*Путь к файлу: `src/components\ui\sheet.tsx`*
...
flowchart TD
    ...
    sheet_tsx --> react_dialog
    class_variance_authority[class-variance-authority]
    sheet_tsx --> class_variance_authority
    lucide_react[lucide-react]
    sheet_tsx --> lucide_react
    utils[@/lib/utils]
    sheet_tsx --> utils
```

### `Sheet` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetPortal` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetOverlay` (Variable (CallExpression))

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetTrigger` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetClose` (Variable (PropertyAccessExpression))

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetContent` (Variable (CallExpression))

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetHeader` (ReactComponent)
...
---
### `SheetHeader` (Identifier)

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetFooter` (ReactComponent)
...
---
### `SheetFooter` (Identifier)

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetTitle` (Variable (CallExpression))

*Источник: `src/components\ui\sheet.tsx`*

---
### `SheetDescription` (Variable (CallExpression))
