...
*Путь к файлу: `src/app\api\settings\units-os\[id]\route.ts`*
...
*Источник: `src/app\api\settings\units-os\[id]\route.ts`*
...
**Возвращает:** `Promise<import("E:/Business/Projects/studio/node_modules/next/dist/server/web/spec-extension/response").NextResponse<{ error: string; }> \| import("E:/Business/Projects/studio/node_modules/next/dist/server/web/spec-extension/response").NextResponse<{ success: boolean; message: string; data: any; }>>`
