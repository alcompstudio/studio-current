...
*Путь к файлу: `src/app\api\orders\fix-work-type-column\route.ts`*
...
**Возвращает:** `Promise<import("E:/Business/Projects/studio/node_modules/next/dist/server/web/spec-extension/response").NextResponse<{ message: string; before: any; after: any; }> \| import("E:/Business/Projects/studio/node_modules/next/dist/server/web/spec-extension/response").NextResponse<{ message: string; error: string; }>>`

*Источник: `src/app\api\orders\fix-work-type-column\route.ts`*
