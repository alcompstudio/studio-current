...
*Путь к файлу: `src/app\api\orders\[orderId]\stages\[stageId]\options\[optionId]\route.ts`*
...
*Источник: `src/app\api\orders\[orderId]\stages\[stageId]\options\[optionId]\route.ts`*
