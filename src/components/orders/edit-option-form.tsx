...
export default function EditOptionForm({ etapId, option, currency, onOptionUpdated, onCancel }: EditOptionFormProps) {
    ...
    const form = useForm<OptionFormValues>({
        ...
        defaultValues: {
            ...
            includedInPrice: option.includedInPrice === undefined ? true : option.includedInPrice, // Default to true if undefined
    ...
    // Reset form if the option prop changes
     useEffect(() => {
        form.reset({
             ...
             description: option.description || "",
             isCalculable: option.isCalculable || false,
             includedInPrice: option.includedInPrice === undefined ? true : option.includedInPrice,
             planUnits: option.planUnits,
             unitDivider: option.unitDivider,
             pricePerUnit: option.pricePerUnit,
         });
