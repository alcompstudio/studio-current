...
export default function OrderDetailPage() {
    ...
    const { toast } = useToast();
     ...
     }, [orderId, toast, isLoading, router]); // Added router dependency
                    ...
                    <Card className="shadow-sm border-none">
                        ...
                        <CardContent className="pt-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                                ...
                                <p>{orderData.description || "No description provided."}</p>
                            </div>
                            <div>
                ...
                <TabsContent value="stages" className="mt-6 space-y-4">
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between pb-2">
                            {/* Removed heading as it's redundant with Tab */}
                             {userRole === "Заказчик" && (
                                                                                ...
                                                                                {/* Optionally add delete button for temporary options */}
                                                                                 {userRole === "Заказчик" && (
                                                                                    <Button
                                                                                        size="icon"
                                                                                        variant="ghost"
                                                                                        // onClick={() => handleDeleteTemporaryOption(option.id)} // Example delete handler
                                                                                        className="h-5 w-5 p-0.5 text-muted-foreground hover:text-destructive"
                                                                                        disabled={true} // Disable editing/deleting temporary for now
                                                                                        aria-label="Delete Temporary Option"
                                                                                    >
